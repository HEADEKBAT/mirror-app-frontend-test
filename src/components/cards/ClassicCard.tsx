...
export const ClassicCard: React.FC<ClassicCardProps> = ({ post, user }) => {
    return (
      <Card className="card gap-1 bg-background justify-space-between py-3 text-foreground h-auto shadow-md rounded-xl transition hover:shadow-lg break-inside-avoid">
